...
class SwerveModule:
    ...
    AM_MAG_COUNTS_PER_REV: int = 4096
    CIMCODER_COUNTS_PER_REV: int = 80
    ANALOGUE_ENCODER_COUNTS_PER_REV: int = 1024
    ENCODER_COUNTS_PER_REV: int = AM_MAG_COUNTS_PER_REV
    ...
    STEER_COUNTS_PER_RADIAN = ANALOGUE_ENCODER_COUNTS_PER_REV / math.tau
    ...
    def __init__(self, name: str,
                 steer_talon: ctre.TalonSRX, drive_talon: ctre.TalonSRX,
    ...
    def set_velocity(self, vx: float, vy: float, *, absolute_rotation: bool = True):
        ...
        if absolute_rotation:
            ...
            # desired angle
            delta = constrain_angle(desired_azimuth - self.current_azimuth_sp)
        else:
